...
from src.database.db import check_teacher_exists, create_teacher, teacher_login, get_teacher_subjects, get_attendace_for_teacher
...
def teacher_screen_login():
    ...
    teacher_username = st.text_input("Enter username", placeholder='Sanskar')
...
def regiser_teacher(teacher_username, teacher_name, teacher_pass, teacher_pass_confirm):
...
def teacher_screen_register():
    ...
    teacher_name = st.text_input("Enter name", placeholder="Vivek Sir")
    ...
    with btnc1:
        if st.button('Register now', icon=':material/passkey:', shortcut="control+enter", width='stretch'):
            success, message = regiser_teacher(teacher_username, teacher_name, teacher_pass, teacher_pass_confirm)
            if success:
                st.success(message)
                import time
                time.sleep(2)
