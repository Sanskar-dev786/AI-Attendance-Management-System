...
from src.database.db import get_all_students, create_student, get_student_subjects, get_student_attendece, unenroll_student_to_subject
...
def student_dashboard():
    ...
    with st.spinner('Loading your enrolled subjects..'):
        ...
        logs = get_student_attendece(student_id)
...
def student_screen():
     ...
     if photo_soucrce:
        img = np.array(Image.open(photo_soucrce))
     ...
     if show_registration:
         with st.container(border=True):
               ...
               try:
                    audio_data = st.audio_input('Record a short phase like I am present, My name is Sanskar!')
               except Exception:
